...
public class AuthenticationService {
     ...
     */
    public User authenticate(LoginDAO loginDAO, HttpServletResponse response) {
        UsernamePasswordAuthenticationToken authenticationToken = new UsernamePasswordAuthenticationToken(loginDAO.getLogin(),loginDAO.getPassword());
        Authentication authentication = authenticationManager.authenticate(authenticationToken);
        SecurityContextHolder.getContext().setAuthentication(authentication);

        //Retrieve security user after authentication
        UserDetails securityUser = userDetailsService.loadUserByUsername(loginDAO.getLogin());
...
//        return userDTO;
        ...
        User authUser = userDao.findByUserName(loginDAO.getLogin());
        return authUser;
    }
//
//    /**
